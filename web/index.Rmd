...
<br>
The __1-hr AQI__ shows the value that would result from a monitor's current concentration persisting for the entire AQI averaging period. The map above includes the AQI readings for the pollutants Ozone, PM2.5, and PM10.
