...
<br>
The __1-hr AQI__ is the value that would result from a monitor's current concentration persisting for the entire AQI averaging period. The map above includes the pollutants Ozone, PM-2.5, and PM-10.
