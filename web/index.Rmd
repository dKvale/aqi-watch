...
```{r leafMap, message=F, echo=F, warning=F,  fig.height = 5.2}
library(leaflet)
...
map <- leaflet(data[, c(9,13:17)], width='99%') %>%
  setView(lat = 46.3, lng= -95.2, zoom= 6) %>%
...
<br>
The __1-hr AQI__ shows the value that would result from a monitor's current concentration persisting for the entire AQI averaging period. 
