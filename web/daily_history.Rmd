...
combined_data <- rbind(hourly_history, daily_history)
...
```{r daily_history_o3, message=FALSE, echo=FALSE, results='asis', warning=FALSE, fig.width=14, fig.height=24, eval = F}
